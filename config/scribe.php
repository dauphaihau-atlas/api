...
return [
    ...
    'intro_text' => <<<'INTRO'
            ## Authentication
            All endpoints (except login and register) require a Sanctum bearer token.
            Pass it in the `Authorization` header: `Bearer {token}`.
        INTRO,
    ...
    'auth' => [
        ...
        'extra_info' => 'Obtain a token via the **login** or **register** endpoint, then pass it as `Bearer {token}` in the Authorization header.',
    ],
